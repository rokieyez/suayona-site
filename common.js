...
const MENU = [
  ...
  // 인생 퀘스트 — 현실의 기록이 경험치가 되어 아바타가 자란다 (2026-09-17). 2026-09-18 부모 요청으로 메뉴 이름을 「수아연아」로, 자리를 홈 다음으로
  { href: '/life.html',     label: '수아연아',  key: 'life' },
  { href: '/portfolio.html',label: '작품전시실', key: 'portfolio' },   // 2026-09-15 포트폴리오 → 작품전시실(부모 요청). 주소는 그대로
  // 현실의 상장·급수·처음 해낸 것 (2026-09-14)   // 2026-09-18 부모 요청으로 작품전시실 바로 다음 자리로
  { href: '/honors.html',   label: '업적전시실', key: 'honors' },
...
// 메뉴 「업적전시실」에 새 자랑 점을 붙인다 — 자랑이 올라온 걸 들어가 봐야만 알 수 있었다.
